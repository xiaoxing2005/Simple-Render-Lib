...
public class TestTESR extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("simplerenderlib", "model/PowerChair.png");
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
        ...
        int currentLight = tile.getWorldObj().getLightBrightnessForSkyBlocks(tile.xCoord, tile.yCoord + 1, tile.zCoord, 0);
